...
abstract class Filter extends AbstractEntity
{
    public function __construct(Model $model)
    {
        ...
        $this->_vars = ['filter_name' => null, 'filter_type' => null, 'filter_data' => null, 'filter_bundle_name' => null, 'filter_field_id' => 0, 'filter_display_name' => null, 'filter_id' => 0, 'filter_created' => 0, 'filter_updated' => 0];
    }
    ...
    public function __get($name)
    {
        ...
        elseif ($name === 'display_name')
            return $this->_vars['filter_display_name'];
        elseif ($name === 'id')
    ...
    public function __set($name, $value)
    {
        ...
        elseif ($name === 'display_name')
            $this->_setVar('filter_display_name', $value);
        elseif ($name === 'id')
